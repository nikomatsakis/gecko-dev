...
class RegisterDump
{
  ...
  public:
    ...
    static size_t offsetOfRegister(FloatRegister reg) {
        return offsetof(RegisterDump, fpregs_) + reg.code() * sizeof(fpreg_value_t);
    }
};
...
class MachineState
{
  ...
  public:
    ...
    void setRegisterLocation(FloatRegister reg, fpreg_value_t *dp) {
        fpregs_[reg.code()] = dp;
    }
    ...
    fpreg_value_t read(FloatRegister reg) const {
